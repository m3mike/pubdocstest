...
* [Acknowledgments](Scenario_2_#acknowledgments.)
* [Additional Plan Resources](Emulation_Plan_Scenario_2_#additional-plan-resources.)

### Pre-requisites

Prior to beginning the following emulation Scenario, ensure you have the proper infrastructure requirements and configuration in place as stated in the [Scenario 2 Infrastructure](Infrastructure4.md) documentation.

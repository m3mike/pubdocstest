...
## Emulation Overview
![Operations Flow Diagram](SoftwareFlow.jpeg)
...
The [Resources Folder](sandworm_Resources.) contains the emulated software source code. Executables are provided in password protected zip files located in the specified software folder.  The password is `malware`.
...
[YARA rules](sandworm_yara-rules.) are provided to assist the community in researching, preventing, and detecting malware specimens used in this emulation plan.

### Emulation Key Software 💻

- [P.A.S. webshell](phpWebShell.)

- [Exaramel](Exaramel.)

- [NotPetya](NotPetya.)

- [OraDump/LaZagne Varient](browser-creds.)

- [Win64/Spy.KeyLogger.G](keylogger.)

### Scenario Walkthrough
- [Detection Scenario](Emulation_Plan_Scenario_1.) - Step by Step walkthrough of Scenario's procedures (9 steps). 
- [Protection Scenario](Emulation_Plan_Scenario_2.) - Step by Step walkthrough of Scenario's procedures (3 tests)

## For Analysts 🔎
- [Operation Flow](sandworm_Operations_Flow_Operations_Flow.md) - High-level summary of the scenario & infrastructure with diagrams. 
- [Intelligence Summary](sandworm_Intelligence_Summary_Intelligence_Summary.md) - General overview of the Adversary with links to reporting used throughout the scenario. 

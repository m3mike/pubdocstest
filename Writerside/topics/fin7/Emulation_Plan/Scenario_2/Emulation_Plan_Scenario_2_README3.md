...
If testing with Microsoft Word, perform the following. If not, perform [Step 1.B*](Scenario_2_#1b---user-execution-malicious-file-without-using-microsoft-word.) instead.
